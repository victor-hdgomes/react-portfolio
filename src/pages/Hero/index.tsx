            ...
            <div className="container relative mx-auto px-4 pt-12 pb-24">
                <div className="flex flex-col items-center justify-center text-center z-10">
                    ...
                    >
                        ...
                        <img src={profilepic} alt="Victor Hugo" className="w-[250px] relative z-10" />
                    </motion.div>
                    ...
                    >
                        <h1 className="text-6xl md:text-7xl font-bold tracking-tighter mb-4">
                            Hi, I am <br /> <span className="text-emerald-400">Victor</span> Hugo
                        </h1>

                        <p className="text-xl text-white/80 max-w-lg mx-auto leading-relaxed mb-6">
                            I am a fullstack developer focusing on creating websites and mobile apps that provides user with best experience.
                        </p>
